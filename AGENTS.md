...
- **Expandable rows:** `panel3-market.js` shows 3 rows by default and toggles to 10 with `...see more...` / `Show fewer`; `panel4-schools.js` shows 3 by default and toggles to 10. These are panel-local toggles, not global state.
